# This example tests and demonstrates the BME69X_PARALLEL_MODE with ULP (300 sec low power)
# With use of BSEC
...
# Initialize sensor in parallel mode Bus=1 debug=0
print('\n\nPARALLEL MODE WITH BSEC')
sensor = BME69X(cnst.BME69X_I2C_ADDR_HIGH, 1, 0)
# Set the heater up
print(sensor.set_heatr_conf(cnst.BME69X_ENABLE,
      temp_prof, dur_prof, cnst.BME69X_PARALLEL_MODE))
# set ULP sample rate
